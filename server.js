...
const {
    ...
    getCurrentUser,
    userLeave,
    getRoomUsers,}=require('./util/users');
...
io.on('connection',socket => {
    ...
    socket.broadcast.to(user.room).emit('message',formatMessage(bot,`${user.username} is connected!`)); //it will emit(tell) to everyone except himself
